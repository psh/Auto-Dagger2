...
On the component, you can add dependencies, modules and superinterfaces.  As you can see, 
the `@Singleton` annotation is applied to the generated component as well.
